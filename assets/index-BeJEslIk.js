(function(){const j=document.createElement("link").relList;if(j&&j.supports&&j.supports("modulepreload"))return;for(const h of document.querySelectorAll('link[rel="modulepreload"]'))s(h);new MutationObserver(h=>{for(const N of h)if(N.type==="childList")for(const O of N.addedNodes)O.tagName==="LINK"&&O.rel==="modulepreload"&&s(O)}).observe(document,{childList:!0,subtree:!0});function g(h){const N={};return h.integrity&&(N.integrity=h.integrity),h.referrerPolicy&&(N.referrerPolicy=h.referrerPolicy),h.crossOrigin==="use-credentials"?N.credentials="include":h.crossOrigin==="anonymous"?N.credentials="omit":N.credentials="same-origin",N}function s(h){if(h.ep)return;h.ep=!0;const N=g(h);fetch(h.href,N)}})();function xh(u){return u&&u.__esModule&&Object.prototype.hasOwnProperty.call(u,"default")?u.default:u}var xc={exports:{}},En={};var Af;function vh(){if(Af)return En;Af=1;var u=Symbol.for("react.transitional.element"),j=Symbol.for("react.fragment");function g(s,h,N){var O=null;if(N!==void 0&&(O=""+N),h.key!==void 0&&(O=""+h.key),"key"in h){N={};for(var B in h)B!=="key"&&(N[B]=h[B])}else N=h;return h=N.ref,{$$typeof:u,type:s,key:O,ref:h!==void 0?h:null,props:N}}return En.Fragment=j,En.jsx=g,En.jsxs=g,En}var Cf;function yh(){return Cf||(Cf=1,xc.exports=vh()),xc.exports}var i=yh(),vc={exports:{}},W={};var Mf;function jh(){if(Mf)return W;Mf=1;var u=Symbol.for("react.transitional.element"),j=Symbol.for("react.portal"),g=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),h=Symbol.for("react.profiler"),N=Symbol.for("react.consumer"),O=Symbol.for("react.context"),B=Symbol.for("react.forward_ref"),_=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),C=Symbol.for("react.lazy"),M=Symbol.for("react.activity"),X=Symbol.iterator;function F(m){return m===null||typeof m!="object"?null:(m=X&&m[X]||m["@@iterator"],typeof m=="function"?m:null)}var H={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},G=Object.assign,Le={};function Te(m,A,q){this.props=m,this.context=A,this.refs=Le,this.updater=q||H}Te.prototype.isReactComponent={},Te.prototype.setState=function(m,A){if(typeof m!="object"&&typeof m!="function"&&m!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,m,A,"setState")},Te.prototype.forceUpdate=function(m){this.updater.enqueueForceUpdate(this,m,"forceUpdate")};function $(){}$.prototype=Te.prototype;function ce(m,A,q){this.props=m,this.context=A,this.refs=Le,this.updater=q||H}var Oe=ce.prototype=new $;Oe.constructor=ce,G(Oe,Te.prototype),Oe.isPureReactComponent=!0;var Fe=Array.isArray;function _e(){}var U={H:null,A:null,T:null,S:null},k=Object.prototype.hasOwnProperty;function te(m,A,q){var Z=q.ref;return{$$typeof:u,type:m,key:A,ref:Z!==void 0?Z:null,props:q}}function $e(m,A){return te(m.type,A,m.props)}function Qe(m){return typeof m=="object"&&m!==null&&m.$$typeof===u}function Ue(m){var A={"=":"=0",":":"=2"};return"$"+m.replace(/[=:]/g,function(q){return A[q]})}var L=/\/+/g;function pe(m,A){return typeof m=="object"&&m!==null&&m.key!=null?Ue(""+m.key):A.toString(36)}function at(m){switch(m.status){case"fulfilled":return m.value;case"rejected":throw m.reason;default:switch(typeof m.status=="string"?m.then(_e,_e):(m.status="pending",m.then(function(A){m.status==="pending"&&(m.status="fulfilled",m.value=A)},function(A){m.status==="pending"&&(m.status="rejected",m.reason=A)})),m.status){case"fulfilled":return m.value;case"rejected":throw m.reason}}throw m}function w(m,A,q,Z,P){var ae=typeof m;(ae==="undefined"||ae==="boolean")&&(m=null);var me=!1;if(m===null)me=!0;else switch(ae){case"bigint":case"string":case"number":me=!0;break;case"object":switch(m.$$typeof){case u:case j:me=!0;break;case C:return me=m._init,w(me(m._payload),A,q,Z,P)}}if(me)return P=P(m),me=Z===""?"."+pe(m,0):Z,Fe(P)?(q="",me!=null&&(q=me.replace(L,"$&/")+"/"),w(P,A,q,"",function(kl){return kl})):P!=null&&(Qe(P)&&(P=$e(P,q+(P.key==null||m&&m.key===P.key?"":(""+P.key).replace(L,"$&/")+"/")+me)),A.push(P)),1;me=0;var Ie=Z===""?".":Z+":";if(Fe(m))for(var Me=0;Me<m.length;Me++)Z=m[Me],ae=Ie+pe(Z,Me),me+=w(Z,A,q,ae,P);else if(Me=F(m),typeof Me=="function")for(m=Me.call(m),Me=0;!(Z=m.next()).done;)Z=Z.value,ae=Ie+pe(Z,Me++),me+=w(Z,A,q,ae,P);else if(ae==="object"){if(typeof m.then=="function")return w(at(m),A,q,Z,P);throw A=String(m),Error("Objects are not valid as a React child (found: "+(A==="[object Object]"?"object with keys {"+Object.keys(m).join(", ")+"}":A)+"). If you meant to render a collection of children, use an array instead.")}return me}function R(m,A,q){if(m==null)return m;var Z=[],P=0;return w(m,Z,"","",function(ae){return A.call(q,ae,P++)}),Z}function J(m){if(m._status===-1){var A=m._result;A=A(),A.then(function(q){(m._status===0||m._status===-1)&&(m._status=1,m._result=q)},function(q){(m._status===0||m._status===-1)&&(m._status=2,m._result=q)}),m._status===-1&&(m._status=0,m._result=A)}if(m._status===1)return m._result.default;throw m._result}var be=typeof reportError=="function"?reportError:function(m){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var A=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof m=="object"&&m!==null&&typeof m.message=="string"?String(m.message):String(m),error:m});if(!window.dispatchEvent(A))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",m);return}console.error(m)},je={map:R,forEach:function(m,A,q){R(m,function(){A.apply(this,arguments)},q)},count:function(m){var A=0;return R(m,function(){A++}),A},toArray:function(m){return R(m,function(A){return A})||[]},only:function(m){if(!Qe(m))throw Error("React.Children.only expected to receive a single React element child.");return m}};return W.Activity=M,W.Children=je,W.Component=Te,W.Fragment=g,W.Profiler=h,W.PureComponent=ce,W.StrictMode=s,W.Suspense=_,W.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=U,W.__COMPILER_RUNTIME={__proto__:null,c:function(m){return U.H.useMemoCache(m)}},W.cache=function(m){return function(){return m.apply(null,arguments)}},W.cacheSignal=function(){return null},W.cloneElement=function(m,A,q){if(m==null)throw Error("The argument must be a React element, but you passed "+m+".");var Z=G({},m.props),P=m.key;if(A!=null)for(ae in A.key!==void 0&&(P=""+A.key),A)!k.call(A,ae)||ae==="key"||ae==="__self"||ae==="__source"||ae==="ref"&&A.ref===void 0||(Z[ae]=A[ae]);var ae=arguments.length-2;if(ae===1)Z.children=q;else if(1<ae){for(var me=Array(ae),Ie=0;Ie<ae;Ie++)me[Ie]=arguments[Ie+2];Z.children=me}return te(m.type,P,Z)},W.createContext=function(m){return m={$$typeof:O,_currentValue:m,_currentValue2:m,_threadCount:0,Provider:null,Consumer:null},m.Provider=m,m.Consumer={$$typeof:N,_context:m},m},W.createElement=function(m,A,q){var Z,P={},ae=null;if(A!=null)for(Z in A.key!==void 0&&(ae=""+A.key),A)k.call(A,Z)&&Z!=="key"&&Z!=="__self"&&Z!=="__source"&&(P[Z]=A[Z]);var me=arguments.length-2;if(me===1)P.children=q;else if(1<me){for(var Ie=Array(me),Me=0;Me<me;Me++)Ie[Me]=arguments[Me+2];P.children=Ie}if(m&&m.defaultProps)for(Z in me=m.defaultProps,me)P[Z]===void 0&&(P[Z]=me[Z]);return te(m,ae,P)},W.createRef=function(){return{current:null}},W.forwardRef=function(m){return{$$typeof:B,render:m}},W.isValidElement=Qe,W.lazy=function(m){return{$$typeof:C,_payload:{_status:-1,_result:m},_init:J}},W.memo=function(m,A){return{$$typeof:b,type:m,compare:A===void 0?null:A}},W.startTransition=function(m){var A=U.T,q={};U.T=q;try{var Z=m(),P=U.S;P!==null&&P(q,Z),typeof Z=="object"&&Z!==null&&typeof Z.then=="function"&&Z.then(_e,be)}catch(ae){be(ae)}finally{A!==null&&q.types!==null&&(A.types=q.types),U.T=A}},W.unstable_useCacheRefresh=function(){return U.H.useCacheRefresh()},W.use=function(m){return U.H.use(m)},W.useActionState=function(m,A,q){return U.H.useActionState(m,A,q)},W.useCallback=function(m,A){return U.H.useCallback(m,A)},W.useContext=function(m){return U.H.useContext(m)},W.useDebugValue=function(){},W.useDeferredValue=function(m,A){return U.H.useDeferredValue(m,A)},W.useEffect=function(m,A){return U.H.useEffect(m,A)},W.useEffectEvent=function(m){return U.H.useEffectEvent(m)},W.useId=function(){return U.H.useId()},W.useImperativeHandle=function(m,A,q){return U.H.useImperativeHandle(m,A,q)},W.useInsertionEffect=function(m,A){return U.H.useInsertionEffect(m,A)},W.useLayoutEffect=function(m,A){return U.H.useLayoutEffect(m,A)},W.useMemo=function(m,A){return U.H.useMemo(m,A)},W.useOptimistic=function(m,A){return U.H.useOptimistic(m,A)},W.useReducer=function(m,A,q){return U.H.useReducer(m,A,q)},W.useRef=function(m){return U.H.useRef(m)},W.useState=function(m){return U.H.useState(m)},W.useSyncExternalStore=function(m,A,q){return U.H.useSyncExternalStore(m,A,q)},W.useTransition=function(){return U.H.useTransition()},W.version="19.2.4",W}var kf;function Ec(){return kf||(kf=1,vc.exports=jh()),vc.exports}var D=Ec();const Yf=xh(D);var yc={exports:{}},Tn={},jc={exports:{}},Sc={};var Df;function Sh(){return Df||(Df=1,(function(u){function j(w,R){var J=w.length;w.push(R);e:for(;0<J;){var be=J-1>>>1,je=w[be];if(0<h(je,R))w[be]=R,w[J]=je,J=be;else break e}}function g(w){return w.length===0?null:w[0]}function s(w){if(w.length===0)return null;var R=w[0],J=w.pop();if(J!==R){w[0]=J;e:for(var be=0,je=w.length,m=je>>>1;be<m;){var A=2*(be+1)-1,q=w[A],Z=A+1,P=w[Z];if(0>h(q,J))Z<je&&0>h(P,q)?(w[be]=P,w[Z]=J,be=Z):(w[be]=q,w[A]=J,be=A);else if(Z<je&&0>h(P,J))w[be]=P,w[Z]=J,be=Z;else break e}}return R}function h(w,R){var J=w.sortIndex-R.sortIndex;return J!==0?J:w.id-R.id}if(u.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var N=performance;u.unstable_now=function(){return N.now()}}else{var O=Date,B=O.now();u.unstable_now=function(){return O.now()-B}}var _=[],b=[],C=1,M=null,X=3,F=!1,H=!1,G=!1,Le=!1,Te=typeof setTimeout=="function"?setTimeout:null,$=typeof clearTimeout=="function"?clearTimeout:null,ce=typeof setImmediate<"u"?setImmediate:null;function Oe(w){for(var R=g(b);R!==null;){if(R.callback===null)s(b);else if(R.startTime<=w)s(b),R.sortIndex=R.expirationTime,j(_,R);else break;R=g(b)}}function Fe(w){if(G=!1,Oe(w),!H)if(g(_)!==null)H=!0,_e||(_e=!0,Ue());else{var R=g(b);R!==null&&at(Fe,R.startTime-w)}}var _e=!1,U=-1,k=5,te=-1;function $e(){return Le?!0:!(u.unstable_now()-te<k)}function Qe(){if(Le=!1,_e){var w=u.unstable_now();te=w;var R=!0;try{e:{H=!1,G&&(G=!1,$(U),U=-1),F=!0;var J=X;try{t:{for(Oe(w),M=g(_);M!==null&&!(M.expirationTime>w&&$e());){var be=M.callback;if(typeof be=="function"){M.callback=null,X=M.priorityLevel;var je=be(M.expirationTime<=w);if(w=u.unstable_now(),typeof je=="function"){M.callback=je,Oe(w),R=!0;break t}M===g(_)&&s(_),Oe(w)}else s(_);M=g(_)}if(M!==null)R=!0;else{var m=g(b);m!==null&&at(Fe,m.startTime-w),R=!1}}break e}finally{M=null,X=J,F=!1}R=void 0}}finally{R?Ue():_e=!1}}}var Ue;if(typeof ce=="function")Ue=function(){ce(Qe)};else if(typeof MessageChannel<"u"){var L=new MessageChannel,pe=L.port2;L.port1.onmessage=Qe,Ue=function(){pe.postMessage(null)}}else Ue=function(){Te(Qe,0)};function at(w,R){U=Te(function(){w(u.unstable_now())},R)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(w){w.callback=null},u.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):k=0<w?Math.floor(1e3/w):5},u.unstable_getCurrentPriorityLevel=function(){return X},u.unstable_next=function(w){switch(X){case 1:case 2:case 3:var R=3;break;default:R=X}var J=X;X=R;try{return w()}finally{X=J}},u.unstable_requestPaint=function(){Le=!0},u.unstable_runWithPriority=function(w,R){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var J=X;X=w;try{return R()}finally{X=J}},u.unstable_scheduleCallback=function(w,R,J){var be=u.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?be+J:be):J=be,w){case 1:var je=-1;break;case 2:je=250;break;case 5:je=1073741823;break;case 4:je=1e4;break;default:je=5e3}return je=J+je,w={id:C++,callback:R,priorityLevel:w,startTime:J,expirationTime:je,sortIndex:-1},J>be?(w.sortIndex=J,j(b,w),g(_)===null&&w===g(b)&&(G?($(U),U=-1):G=!0,at(Fe,J-be))):(w.sortIndex=je,j(_,w),H||F||(H=!0,_e||(_e=!0,Ue()))),w},u.unstable_shouldYield=$e,u.unstable_wrapCallback=function(w){var R=X;return function(){var J=X;X=R;try{return w.apply(this,arguments)}finally{X=J}}}})(Sc)),Sc}var Of;function Nh(){return Of||(Of=1,jc.exports=Sh()),jc.exports}var Nc={exports:{}},Pe={};var Uf;function wh(){if(Uf)return Pe;Uf=1;var u=Ec();function j(_){var b="https://react.dev/errors/"+_;if(1<arguments.length){b+="?args[]="+encodeURIComponent(arguments[1]);for(var C=2;C<arguments.length;C++)b+="&args[]="+encodeURIComponent(arguments[C])}return"Minified React error #"+_+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function g(){}var s={d:{f:g,r:function(){throw Error(j(522))},D:g,C:g,L:g,m:g,X:g,S:g,M:g},p:0,findDOMNode:null},h=Symbol.for("react.portal");function N(_,b,C){var M=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:h,key:M==null?null:""+M,children:_,containerInfo:b,implementation:C}}var O=u.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function B(_,b){if(_==="font")return"";if(typeof b=="string")return b==="use-credentials"?b:""}return Pe.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=s,Pe.createPortal=function(_,b){var C=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!b||b.nodeType!==1&&b.nodeType!==9&&b.nodeType!==11)throw Error(j(299));return N(_,b,null,C)},Pe.flushSync=function(_){var b=O.T,C=s.p;try{if(O.T=null,s.p=2,_)return _()}finally{O.T=b,s.p=C,s.d.f()}},Pe.preconnect=function(_,b){typeof _=="string"&&(b?(b=b.crossOrigin,b=typeof b=="string"?b==="use-credentials"?b:"":void 0):b=null,s.d.C(_,b))},Pe.prefetchDNS=function(_){typeof _=="string"&&s.d.D(_)},Pe.preinit=function(_,b){if(typeof _=="string"&&b&&typeof b.as=="string"){var C=b.as,M=B(C,b.crossOrigin),X=typeof b.integrity=="string"?b.integrity:void 0,F=typeof b.fetchPriority=="string"?b.fetchPriority:void 0;C==="style"?s.d.S(_,typeof b.precedence=="string"?b.precedence:void 0,{crossOrigin:M,integrity:X,fetchPriority:F}):C==="script"&&s.d.X(_,{crossOrigin:M,integrity:X,fetchPriority:F,nonce:typeof b.nonce=="string"?b.nonce:void 0})}},Pe.preinitModule=function(_,b){if(typeof _=="string")if(typeof b=="object"&&b!==null){if(b.as==null||b.as==="script"){var C=B(b.as,b.crossOrigin);s.d.M(_,{crossOrigin:C,integrity:typeof b.integrity=="string"?b.integrity:void 0,nonce:typeof b.nonce=="string"?b.nonce:void 0})}}else b==null&&s.d.M(_)},Pe.preload=function(_,b){if(typeof _=="string"&&typeof b=="object"&&b!==null&&typeof b.as=="string"){var C=b.as,M=B(C,b.crossOrigin);s.d.L(_,C,{crossOrigin:M,integrity:typeof b.integrity=="string"?b.integrity:void 0,nonce:typeof b.nonce=="string"?b.nonce:void 0,type:typeof b.type=="string"?b.type:void 0,fetchPriority:typeof b.fetchPriority=="string"?b.fetchPriority:void 0,referrerPolicy:typeof b.referrerPolicy=="string"?b.referrerPolicy:void 0,imageSrcSet:typeof b.imageSrcSet=="string"?b.imageSrcSet:void 0,imageSizes:typeof b.imageSizes=="string"?b.imageSizes:void 0,media:typeof b.media=="string"?b.media:void 0})}},Pe.preloadModule=function(_,b){if(typeof _=="string")if(b){var C=B(b.as,b.crossOrigin);s.d.m(_,{as:typeof b.as=="string"&&b.as!=="script"?b.as:void 0,crossOrigin:C,integrity:typeof b.integrity=="string"?b.integrity:void 0})}else s.d.m(_)},Pe.requestFormReset=function(_){s.d.r(_)},Pe.unstable_batchedUpdates=function(_,b){return _(b)},Pe.useFormState=function(_,b,C){return O.H.useFormState(_,b,C)},Pe.useFormStatus=function(){return O.H.useHostTransitionStatus()},Pe.version="19.2.4",Pe}var Bf;function zh(){if(Bf)return Nc.exports;Bf=1;function u(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(u)}catch(j){console.error(j)}}return u(),Nc.exports=wh(),Nc.exports}var Hf;function Eh(){if(Hf)return Tn;Hf=1;var u=Nh(),j=Ec(),g=zh();function s(e){var t="https://react.dev/errors/"+e;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)t+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function h(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function N(e){var t=e,a=e;if(e.alternate)for(;t.return;)t=t.return;else{e=t;do t=e,(t.flags&4098)!==0&&(a=t.return),e=t.return;while(e)}return t.tag===3?a:null}function O(e){if(e.tag===13){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function B(e){if(e.tag===31){var t=e.memoizedState;if(t===null&&(e=e.alternate,e!==null&&(t=e.memoizedState)),t!==null)return t.dehydrated}return null}function _(e){if(N(e)!==e)throw Error(s(188))}function b(e){var t=e.alternate;if(!t){if(t=N(e),t===null)throw Error(s(188));return t!==e?null:e}for(var a=e,l=t;;){var n=a.return;if(n===null)break;var r=n.alternate;if(r===null){if(l=n.return,l!==null){a=l;continue}break}if(n.child===r.child){for(r=n.child;r;){if(r===a)return _(n),e;if(r===l)return _(n),t;r=r.sibling}throw Error(s(188))}if(a.return!==l.return)a=n,l=r;else{for(var o=!1,c=n.child;c;){if(c===a){o=!0,a=n,l=r;break}if(c===l){o=!0,l=n,a=r;break}c=c.sibling}if(!o){for(c=r.child;c;){if(c===a){o=!0,a=r,l=n;break}if(c===l){o=!0,l=r,a=n;break}c=c.sibling}if(!o)throw Error(s(189))}}if(a.alternate!==l)throw Error(s(190))}if(a.tag!==3)throw Error(s(188));return a.stateNode.current===a?e:t}function C(e){var t=e.tag;if(t===5||t===26||t===27||t===6)return e;for(e=e.child;e!==null;){if(t=C(e),t!==null)return t;e=e.sibling}return null}var M=Object.assign,X=Symbol.for("react.element"),F=Symbol.for("react.transitional.element"),H=Symbol.for("react.portal"),G=Symbol.for("react.fragment"),Le=Symbol.for("react.strict_mode"),Te=Symbol.for("react.profiler"),$=Symbol.for("react.consumer"),ce=Symbol.for("react.context"),Oe=Symbol.for("react.forward_ref"),Fe=Symbol.for("react.suspense"),_e=Symbol.for("react.suspense_list"),U=Symbol.for("react.memo"),k=Symbol.for("react.lazy"),te=Symbol.for("react.activity"),$e=Symbol.for("react.memo_cache_sentinel"),Qe=Symbol.iterator;function Ue(e){return e===null||typeof e!="object"?null:(e=Qe&&e[Qe]||e["@@iterator"],typeof e=="function"?e:null)}var L=Symbol.for("react.client.reference");function pe(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===L?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case G:return"Fragment";case Te:return"Profiler";case Le:return"StrictMode";case Fe:return"Suspense";case _e:return"SuspenseList";case te:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case H:return"Portal";case ce:return e.displayName||"Context";case $:return(e._context.displayName||"Context")+".Consumer";case Oe:var t=e.render;return e=e.displayName,e||(e=t.displayName||t.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case U:return t=e.displayName||null,t!==null?t:pe(e.type)||"Memo";case k:t=e._payload,e=e._init;try{return pe(e(t))}catch{}}return null}var at=Array.isArray,w=j.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,R=g.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,J={pending:!1,data:null,method:null,action:null},be=[],je=-1;function m(e){return{current:e}}function A(e){0>je||(e.current=be[je],be[je]=null,je--)}function q(e,t){je++,be[je]=e.current,e.current=t}var Z=m(null),P=m(null),ae=m(null),me=m(null);function Ie(e,t){switch(q(ae,t),q(P,e),q(Z,null),t.nodeType){case 9:case 11:e=(e=t.documentElement)&&(e=e.namespaceURI)?$d(e):0;break;default:if(e=t.tagName,t=t.namespaceURI)t=$d(t),e=Pd(t,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}A(Z),q(Z,e)}function Me(){A(Z),A(P),A(ae)}function kl(e){e.memoizedState!==null&&q(me,e);var t=Z.current,a=Pd(t,e.type);t!==a&&(q(P,e),q(Z,a))}function Mn(e){P.current===e&&(A(Z),A(P)),me.current===e&&(A(me),Sn._currentValue=J)}var Ii,Tc;function Ta(e){if(Ii===void 0)try{throw Error()}catch(a){var t=a.stack.trim().match(/\n( *(at )?)/);Ii=t&&t[1]||"",Tc=-1<a.stack.indexOf(`
...
**Zervo Company — Creating an Aura That Speaks.**`},subServices:[{title:"Full Home Painting",description:"Complete house makeover with premium finishes.",price:"4999",rating:4.9,image:"/hero service (2).png",isMostBooked:!0},{title:"Textured Wall Painting",description:"Designer wall patterns and effects.",price:"999",rating:4.8,image:"/hero service (2).png",isMostBooked:!0},{title:"Exterior Painting",description:"Weather-resistant solutions for your home's exterior.",price:"5999",rating:4.7,image:"/hero service (2).png"}],reviews:[]},"water-proofing":{id:"water-proofing",title:"Water proofing",description:"Stop leakage and dampness permanently.",rating:4.8,reviewsCount:"1200+",heroImage:"/plumber.jpeg",expertImage:"/plumber.jpeg",about:{title:"Expert Water Proofing Solutions",description:"Our professional water proofing services ensure your home stays dry and protected from seepage, leaks, and dampness. We use advanced materials and techniques for long-lasting results."},subServices:[{title:"Roof Water Proofing",description:"Terrace leakage solution.",price:"1999",rating:4.8,image:"/plumber.jpeg"},{title:"Bathroom Water Proofing",description:"Stop floor seepage.",price:"999",rating:4.7,image:"/plumber.jpeg"}],reviews:[]},"tile-grouting":{id:"tile-grouting",title:"Tile grouting",description:"Epoxy and cement-based tile gap filling.",rating:4.7,reviewsCount:"800+",heroImage:"/plumber.jpeg",expertImage:"/plumber.jpeg",about:{title:"Seamless Tile Grouting",description:"Enhance the look and durability of your tiles with our expert grouting services. We provide both epoxy and cement-based solutions for stain-resistant and waterproof gaps."},subServices:[{title:"Epoxy Grouting",description:"Stain-resistant and highly durable tile gaps.",price:"499",rating:4.8,image:"/plumber.jpeg"},{title:"Tile Repair & Grouting",description:"Fix loose tiles and fill gaps perfectly.",price:"299",rating:4.6,image:"/plumber.jpeg"}],reviews:[]},"wall-modelling":{id:"wall-modelling",title:"Wall modelling",description:"Luxury PVC and wooden wall paneling.",rating:4.9,reviewsCount:"1100+",heroImage:"/home cleaning.jpg",expertImage:"/home cleaning.jpg",about:{title:"Premium Wall Paneling & Modelling",description:"Transform your walls with our luxury modelling services. From PVC panels to premium wooden wall modelling, we create sophisticated interiors that stand out."},subServices:[{title:"PVC Wall Paneling",description:"Durable, stylish, and moisture-resistant.",price:"1499",rating:4.8,image:"/home cleaning.jpg"},{title:"Wooden Wall Modelling",description:"Premium wooden finishes for a luxury look.",price:"2999",rating:4.9,image:"/home cleaning.jpg"}],reviews:[]},"wall-paper":{id:"wall-paper",title:"Wall paper",description:"3D and custom fabric wallpaper installation.",rating:4.8,reviewsCount:"950+",heroImage:"/home cleaning.jpg",expertImage:"/home cleaning.jpg",about:{title:"Custom & 3D Wallpaper Installation",description:"Express your style with our wide range of wallpaper solutions. We specialize in 3D depth effects and custom fabric wallpapers for every room."},subServices:[{title:"3D Wallpaper",description:"Lifelike depth and stunning visual effects.",price:"699",rating:4.8,image:"/home cleaning.jpg"},{title:"Custom Print Wallpaper",description:"Personalized designs to match your decor.",price:"899",rating:4.7,image:"/home cleaning.jpg"}],reviews:[]},"wood-polish":{id:"wood-polish",title:"Wood polish",description:"PU and Melamyne polish for furniture.",rating:4.7,reviewsCount:"850+",heroImage:"/home cleaning.jpg",expertImage:"/home cleaning.jpg",about:{title:"Superior Wood Polishing",description:"Protect and shine your wooden furniture with our premium polishing services. We offer high-gloss PU and classic Melamyne finishes."},subServices:[{title:"PU Polish",description:"High-gloss luxury finish with durability.",price:"1299",rating:4.9,image:"/home cleaning.jpg"},{title:"Furniture Melamyne",description:"Classic protection and sheen for wood.",price:"799",rating:4.6,image:"/home cleaning.jpg"}],reviews:[]},"false-ceiling":{id:"false-ceiling",title:"False ceiling",description:"Modern Gypsum and POP ceiling designs.",rating:4.9,reviewsCount:"1300+",heroImage:"/home cleaning.jpg",expertImage:"/home cleaning.jpg",about:{title:"Innovative False Ceiling Designs",description:"Elevate your space with our modern false ceiling solutions. We specialize in Gypsum and POP designs that combine aesthetics with lighting integration."},subServices:[{title:"Gypsum False Ceiling",description:"Smooth modern look for homes and offices.",price:"1999",rating:4.9,image:"/home cleaning.jpg"},{title:"POP Ceiling Design",description:"Classic and intricate ceiling patterns.",price:"1499",rating:4.7,image:"/home cleaning.jpg"}],reviews:[]}},Xf=D.createContext({data:Qf,loading:!1});function qh({children:u}){const[j,g]=D.useState(Qf),[s,h]=D.useState(!0);return D.useEffect(()=>{Dh().then(N=>{N&&typeof N=="object"&&Object.keys(N).length>0&&g(N)}).catch(()=>{}).finally(()=>h(!1))},[]),i.jsx(Xf.Provider,{value:{data:j,loading:s},children:u})}function Cl(){return D.useContext(Xf)}const Cn=()=>{const[u,j]=D.useState(!1),[g,s]=D.useState(!1),{navigate:h}=tt(),{data:N}=Cl(),O=D.useMemo(()=>Object.entries(N||{}).filter(([b,C])=>b!=="default"&&Array.isArray(C?.subServices)&&C.subServices.length>0).map(([b,C])=>({id:b,title:C.title||b,subtitle:(C.description||"").slice(0,30)+(C.description&&C.description.length>30?"…":"")})),[N]);D.useEffect(()=>{const b=C=>{const M=document.querySelector(".navbar-wrapper");M&&!M.contains(C.target)&&j(!1)};return document.addEventListener("click",b),()=>document.removeEventListener("click",b)},[]);const B=b=>{h(`/#${b}`),j(!1),s(!1);const C=document.getElementById(b);C&&C.scrollIntoView({behavior:"smooth"})},_=()=>{s(!g)};return D.useEffect(()=>(g?document.body.style.overflow="hidden":document.body.style.overflow="auto",()=>{document.body.style.overflow="auto"}),[g]),i.jsxs("nav",{className:"navbar-wrapper",children:[i.jsxs("div",{className:"navbar-inner container",children:[i.jsx(_n,{to:"/",className:"navbar-logo",children:i.jsx("span",{className:"brand-name",children:"Zervo Company"})}),i.jsxs("div",{className:"navbar-links desktop-only",children:[i.jsxs("div",{className:"nav-item-dropdown",children:[i.jsx("button",{className:`nav-link dropdown-toggle ${u?"active":""}`,onClick:()=>j(!u),children:"Services"}),u&&i.jsx("div",{className:"services-dropdown",children:i.jsx("ul",{children:O.map((b,C)=>i.jsxs("li",{className:"dropdown-item",onClick:()=>B(b.id),children:[i.jsx("div",{className:"item-title",children:b.title}),i.jsx("div",{className:"item-subtitle",children:b.subtitle})]},C))})})]}),i.jsx(_n,{to:"/blog",className:"nav-link",children:"Blogs"}),i.jsx(_n,{to:"/",className:"nav-link",children:"App"})]}),i.jsx("div",{className:"navbar-actions desktop-only",children:i.jsxs("button",{className:"btn-primary",onClick:()=>window.open(`https://wa.me/918354067979?text=${encodeURIComponent("Hello Zervo Company, I want to become a service provider.")}`,"_blank"),children:[i.jsx("span",{className:"icon",children:"Store"}),"Become Service Provider"]})}),i.jsx("button",{className:"mobile-menu-btn",onClick:_,children:g?i.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[i.jsx("path",{d:"M18 6L6 18",stroke:"#1f2937",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}),i.jsx("path",{d:"M6 6L18 18",stroke:"#1f2937",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})]}):i.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[i.jsx("path",{d:"M4 6H20",stroke:"#1f2937",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}),i.jsx("path",{d:"M4 12H20",stroke:"#1f2937",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}),i.jsx("path",{d:"M4 18H20",stroke:"#1f2937",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})]})}),g&&i.jsx("div",{className:"mobile-menu-overlay",children:i.jsx("div",{className:"mobile-menu-content",children:i.jsxs("div",{className:"mobile-nav-links",children:[i.jsxs("div",{className:"mobile-nav-item",children:[i.jsx("span",{className:"mobile-nav-header",children:"Services"}),i.jsx("div",{className:"mobile-services-grid",children:O.map((b,C)=>i.jsx("div",{className:"mobile-service-item",onClick:()=>B(b.id),children:b.title},C))})]}),i.jsx(_n,{to:"/blog",className:"mobile-nav-link",onClick:()=>s(!1),children:"Blogs"}),i.jsx(_n,{to:"/",className:"mobile-nav-link",onClick:()=>s(!1),children:"App"}),i.jsx("div",{className:"mobile-nav-item",children:i.jsx("button",{className:"btn-primary width-full",onClick:()=>{window.open(`https://wa.me/918354067979?text=${encodeURIComponent("Hello Zervo Company, I want to become a service provider.")}`,"_blank"),s(!1)},children:"Become Service Provider"})})]})})})]}),i.jsx("style",{children:`
      ...
      `})]})},Gh=()=>{const{navigate:u}=tt(),{data:j}=Cl(),g=Yf.useMemo(()=>Object.entries(j||{}).filter(([s,h])=>s!=="default"&&Array.isArray(h?.subServices)&&h.subServices.length>0).map(([s,h])=>({slug:s,title:h.title||s,image:h.heroImage||h.expertImage||""})),[j]);return g.length===0?null:i.jsxs("section",{className:"category-cards-section",children:[i.jsxs("div",{className:"container",children:[i.jsx("div",{className:"category-cards-tabs",children:i.jsx("button",{type:"button",className:"category-tab active",children:"All services"})}),i.jsx("div",{className:"category-cards-grid",children:g.map(s=>i.jsxs("button",{type:"button",className:"category-card",onClick:()=>u(`/service/${s.slug}`),children:[i.jsx("div",{className:"category-card-image-wrap",children:i.jsx("img",{src:(s.image&&s.image.startsWith("/uploads/")?Ct(s.image):s.image)||"/vite.svg",alt:"",className:"category-card-image"})}),i.jsx("span",{className:"category-card-label",children:s.title})]},s.slug))})]}),i.jsx("style",{children:`
            ...
            `})]})},Zh=({image:u,title:j,rating:g,price:s,isMostBooked:h})=>{const{navigate:N}=tt(),O=()=>{const B=`Hello Zervo Company, I want to book ${j} service.`,_=encodeURIComponent(B);window.open(`https://wa.me/918354067979?text=${_}`,"_blank")};return i.jsxs("div",{className:"service-card",children:[i.jsxs("div",{className:"card-image-container",children:[i.jsx("img",{src:u&&(u.startsWith("http")?u:Ct(u))||"/vite.svg",alt:j,className:"card-image"}),h&&i.jsx("div",{className:"badge-most-booked",children:"MOST BOOKED"}),i.jsxs("div",{className:"badge-rating",children:[i.jsx("span",{className:"star",children:"★"})," ",g]})]}),i.jsxs("div",{className:"card-content",children:[i.jsx("h3",{className:"service-title",children:j}),i.jsxs("div",{className:"card-footer",children:[i.jsxs("div",{className:"price-info",children:[i.jsx("span",{className:"price-label",children:"STARTS FROM"}),i.jsxs("span",{className:"price-value",children:["₹",s]})]}),i.jsx("button",{className:"btn-book",onClick:O,children:"Book Now"})]})]}),i.jsx("style",{children:`
        .service-card {
          background: var(--color-white);
      ...
      `})]})},Qh=({categoryId:u,index:j})=>{const{data:g}=Cl(),s=g?.[u];if(!s)return null;const h=(s.subServices||[]).map((b,C)=>({id:C,...b}));if(h.length===0)return null;const N=j%2===0,O=s.title.split(" "),B=O[0],_=O.slice(1).join(" ");return i.jsxs("section",{className:`home-services-section ${N?"bg-light":"bg-white"}`,id:u,children:[i.jsxs("div",{className:"container",children:[i.jsxs("div",{className:"section-header-left",children:[i.jsxs("h2",{className:"section-title",children:[B," ",_&&i.jsx("span",{className:"text-secondary",children:_}),!_&&i.jsx("span",{className:"text-secondary-dot",children:"."})]}),i.jsx("p",{className:"section-subtitle",children:s.description}),i.jsxs("div",{className:"rating-row",children:[i.jsx("div",{className:"stars",children:"★".repeat(5)}),i.jsxs("span",{className:"rating-text",children:[s.rating||4.8," • ",s.reviewsCount||"1000+"," reviews"]})]})]}),i.jsx("div",{className:"services-grid",children:h.map(b=>i.jsx(Zh,{...b},b.id))})]}),i.jsx("style",{children:`
      ...
      `})]})},Kf=()=>{const[u,j]=D.useState(0),g=h=>{j(u===h?-1:h)},s=[{question:"How do I choose the right paint for my home?",answer:"Our experts at Zervo Company provide a free color consultation to help you choose the right finish and shade based on your lighting, wall condition, and personal style."},{question:"Is your water proofing service permanent?",answer:"Yes, we use advanced multi-layer coating techniques and premium chemicals to provide long-lasting protection. We also offer a warranty on our water proofing solutions."},{question:"What is the benefit of epoxy tile grouting?",answer:"Epoxy grouting is highly durable, stain-resistant, and 100% waterproof. It prevents mold growth in tile gaps and is much easier to clean than regular cement grout."},{question:"How long does wall paneling/modelling installation take?",answer:"Most PVC or wooden wall modelling projects can be completed within 1-3 days depending on the wall size and design complexity."},{question:"Can wallpapers be applied on damp walls?",answer:"We recommend treating damp walls with our water proofing service before applying wallpaper to ensure it doesn't peel and lasts for years."},{question:"What is the difference between PU and Melamyne polish?",answer:"PU polish offers a more premium, high-gloss finish with superior durability and scratch resistance compared to the classic and more affordable Melamyne polish."},{question:"Are false ceilings suitable for small rooms?",answer:"Yes, modern Gypsum or POP false ceilings can actually make small rooms feel more spacious and elegant with the right lighting integration and minimal design."}];return i.jsxs("section",{className:"faq-section",children:[i.jsxs("div",{className:"container",children:[i.jsx("h2",{className:"section-title",children:"Most asked FAQ's"}),i.jsx("p",{className:"section-subtitle",children:"We're here to help you and solve doubts. Find answers to the most common questions below."}),i.jsx("div",{className:"faq-grid",children:s.map((h,N)=>i.jsxs("div",{className:"faq-card",children:[i.jsxs("div",{className:`faq-header ${u===N?"active":""}`,onClick:()=>g(N),children:[i.jsx("h3",{children:h.question}),i.jsx("button",{className:"toggle-btn",children:u===N?i.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:i.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})}):i.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[i.jsx("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),i.jsx("line",{x1:"5",y1:"12",x2:"19",y2:"12"})]})})]}),i.jsx("div",{className:`faq-answer ${u===N?"show":""}`,children:i.jsx("p",{children:h.answer})})]},N))})]}),i.jsx("style",{children:`
        .faq-section {
            padding-top: 4rem;
            padding-bottom: 6rem;
            background-color: var(--color-white);
      ...
      `})]})},Jf=()=>{const[u,j]=D.useState("/banner.png");D.useEffect(()=>{Oh().then(s=>{s&&s.length>0&&s[0]&&j(s[0])}).catch(()=>{})},[]);const g=u.startsWith("/uploads/")?Ct(u):u;return i.jsxs("section",{className:"banner-section",children:[i.jsx("div",{className:"banner-image-container",children:i.jsx("img",{src:g,alt:"Zervo Company Team",className:"banner-image"})}),i.jsx("style",{children:`
        .banner-section {
            padding-top: 4rem;
            text-align: center;
      ...
      `})]})},qf=()=>{const{data:u,loading:j}=Cl(),g=Object.keys(u||{}).filter(s=>{if(s==="default")return!1;const N=u[s]?.subServices||[];return Array.isArray(N)&&N.length>0});return Yf.useEffect(()=>{if(!j&&window.location.hash){const s=window.location.hash.substring(1);setTimeout(()=>{const h=document.getElementById(s);h&&h.scrollIntoView({behavior:"smooth"})},100)}},[j,g.length]),i.jsxs("div",{className:"home-container",children:[i.jsx(Yh,{}),i.jsx(Gh,{}),g.map((s,h)=>i.jsx(Qh,{categoryId:s,index:h},s)),i.jsx(Xh,{}),i.jsx(Vh,{}),i.jsx(Vf,{}),i.jsx(Kf,{}),i.jsx(Jf,{})]})},Kh=()=>{const{navigate:u}=tt();return i.jsxs("div",{className:"partner-page",children:[i.jsx("div",{className:"container partner-container",children:i.jsxs("div",{className:"partner-content",children:[i.jsxs("button",{onClick:()=>u("/"),className:"back-btn",children:[i.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[i.jsx("path",{d:"M19 12H5",stroke:"#111",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"}),i.jsx("path",{d:"M12 19L5 12L12 5",stroke:"#111",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})]}),"Back to Home"]}),i.jsxs("div",{className:"partner-info",children:[i.jsxs("h1",{children:["Join the Zervo Company ",i.jsx("br",{})," Partner Network"]}),i.jsx("p",{className:"subtitle",children:"Are you an expert in your field, ready to showcase your skills and grow your business?"}),i.jsx("p",{className:"description",children:"Join Zervo Company as a trusted service provider and connect with potential clients who need your expertise!"}),i.jsxs("div",{className:"contact-details",children:[i.jsxs("p",{children:["Call us: ",i.jsx("strong",{children:"+91 83540 67979"})]}),i.jsxs("p",{children:["Email us: ",i.jsx("strong",{children:"business@zervocompany.com"})]})]}),i.jsx("div",{className:"cta-grow",children:i.jsx("p",{children:"Let's grow together and unlock new opportunities!"})}),i.jsxs("div",{className:"social-icons",children:[i.jsx("a",{href:"#",className:"social-icon",children:"in"}),i.jsx("a",{href:"#",className:"social-icon",children:"Instagram"}),i.jsx("a",{href:"#",className:"social-icon",children:"Facebook"})]})]}),i.jsx("div",{className:"partner-form-col",children:i.jsxs("form",{className:"partner-form",children:[i.jsxs("div",{className:"form-group",children:[i.jsx("label",{children:"Name"}),i.jsx("input",{type:"text",placeholder:"your name"})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{children:"Phone Number"}),i.jsxs("div",{className:"phone-input-group",children:[i.jsx("span",{className:"flag-icon",children:"🇮🇳"}),i.jsx("span",{className:"country-code",children:"+91"}),i.jsx("input",{type:"tel",placeholder:""})]})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{children:"Service"}),i.jsx("input",{type:"text",placeholder:"service you provide"})]}),i.jsxs("div",{className:"form-group radio-group-container",children:[i.jsx("label",{children:"How did you know about Zervo Company?"}),i.jsxs("div",{className:"radio-option",children:[i.jsx("input",{type:"radio",name:"source",id:"social"}),i.jsx("label",{htmlFor:"social",children:"Social Media"})]}),i.jsxs("div",{className:"radio-option",children:[i.jsx("input",{type:"radio",name:"source",id:"friend"}),i.jsx("label",{htmlFor:"friend",children:"Recommended By Someone"})]}),i.jsxs("div",{className:"radio-option",children:[i.jsx("input",{type:"radio",name:"source",id:"other"}),i.jsx("label",{htmlFor:"other",children:"Other"})]})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{children:"Additional Message"}),i.jsx("textarea",{placeholder:"Type your message here..."})]}),i.jsx("p",{className:"form-note",children:"Any additional details or questions? (Optional)"}),i.jsxs("div",{className:"form-actions",children:[i.jsx("button",{type:"submit",className:"btn-submit",children:"Submit"}),i.jsx("button",{type:"button",className:"btn-whatsapp",children:"Send Whatsapp"})]})]})})]})}),i.jsx(Ml,{}),i.jsx("style",{children:`
            ...
            `})]})},Jh=({serviceName:u})=>{const{navigate:j}=tt(),[g,s]=D.useState({name:"",phone:"",date:"",timeslot:"",address:"",paymentMode:"cash"}),h=u?decodeURIComponent(u):"Service",N=B=>{const{name:_,value:b}=B.target;if(_==="phone"){const C=b.replace(/[^0-9]/g,"");s({...g,[_]:C})}else s({...g,[_]:b})},O=B=>{B.preventDefault();const _=`Hello Zervo Company, I want to book ${h}.
Details:
Name: ${g.name}
Phone: ${g.phone}
Date: ${g.date}
...
Message: ${O}`;window.open(`https://wa.me/918354067979?text=${encodeURIComponent(B)}`,"_blank")},children:[i.jsxs("div",{className:"form-group",children:[i.jsx("label",{children:"Name"}),i.jsx("input",{type:"text",name:"name",placeholder:"Your Name",required:!0})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{children:"Email"}),i.jsx("input",{type:"email",name:"email",placeholder:"Your Email",required:!0})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{children:"Phone"}),i.jsx("input",{type:"tel",name:"phone",placeholder:"Your Phone Number",onInput:j=>{j.target.value=j.target.value.replace(/[^0-9]/g,"")},required:!0})]}),i.jsxs("div",{className:"form-group",children:[i.jsx("label",{children:"Message"}),i.jsx("textarea",{name:"message",placeholder:"How can we help you?",required:!0})]}),i.jsx("button",{type:"submit",className:"btn-submit",children:"Send Message"})]})]})]})]}),i.jsx(Ml,{}),i.jsx("style",{children:`
            ...
            `})]}),$h=()=>{const[u,j]=D.useState({title:"Privacy Policy",content:"",updated_at:null}),[g,s]=D.useState(!0);D.useEffect(()=>{Zf("privacy").then(N=>j(N)).catch(()=>{}).finally(()=>s(!1))},[]);const h=u.updated_at?new Date(u.updated_at).toLocaleDateString("en-IN",{year:"numeric",month:"long",day:"numeric"}):null;return i.jsxs("div",{className:"policy-page",children:[i.jsx(Cn,{}),i.jsxs("div",{className:"container policy-container",children:[i.jsx("h1",{children:u.title}),h&&i.jsxs("p",{className:"last-updated",children:["Last updated: ",h]}),g?i.jsx("p",{children:"Loading…"}):i.jsx("div",{className:"policy-content",dangerouslySetInnerHTML:{__html:u.content||"<p>No content yet.</p>"}})]}),i.jsx(Ml,{}),i.jsx("style",{children:`
            ...
            `})]})},Ph=()=>{const[u,j]=D.useState({title:"Terms and Conditions",content:"",updated_at:null}),[g,s]=D.useState(!0);D.useEffect(()=>{Zf("terms").then(N=>j(N)).catch(()=>{}).finally(()=>s(!1))},[]);const h=u.updated_at?new Date(u.updated_at).toLocaleDateString("en-IN",{year:"numeric",month:"long",day:"numeric"}):null;return i.jsxs("div",{className:"policy-page",children:[i.jsx(Cn,{}),i.jsxs("div",{className:"container policy-container",children:[i.jsx("h1",{children:u.title}),h&&i.jsxs("p",{className:"last-updated",children:["Last updated: ",h]}),g?i.jsx("p",{children:"Loading…"}):i.jsx("div",{className:"policy-content",dangerouslySetInnerHTML:{__html:u.content||"<p>No content yet.</p>"}})]}),i.jsx(Ml,{}),i.jsx("style",{children:`
                .policy-page { background: #f9fafb; min-height: 100vh; }
                .policy-container { padding: 4rem 1rem; max-width: 800px; margin: 0 auto; color: #374151; }
                .policy-container h1 { font-size: 2.5rem; font-weight: 800; color: #111; margin-bottom: 1rem; }
                .last-updated { color: #6b7280; margin-bottom: 2rem; }
      ...
      `})]})},rp=()=>{const[u,j]=D.useState([]),[g,s]=D.useState(0);if(D.useEffect(()=>{Uh().then(j).catch(()=>j([]))},[]),D.useEffect(()=>{if(u.length<=1)return;const O=setInterval(()=>s(B=>(B+1)%u.length),5e3);return()=>clearInterval(O)},[u.length]),!u.length)return null;const h=u[g];return h?i.jsxs("div",{className:"top-offer-bar",style:{background:h.bg_color||"#6366f1",color:h.text_color||"#ffffff"},children:[i.jsxs("div",{className:"container top-offer-inner",children:[h.link_url?i.jsx("a",{href:h.link_url,target:"_blank",rel:"noopener noreferrer",className:"top-offer-link",children:h.text}):i.jsx("span",{children:h.text}),u.length>1&&i.jsx("div",{className:"top-offer-dots",children:u.map((O,B)=>i.jsx("button",{type:"button",className:`top-offer-dot ${B===g?"active":""}`,onClick:()=>s(B),"aria-label":`Offer ${B+1}`},B))})]}),i.jsx("style",{children:`
      ...
      `})]})},sp=({title:u,description:j,rating:g,reviewsCount:s,expertImage:h})=>i.jsxs("div",{className:"service-hero-section",children:[i.jsxs("div",{className:"container service-hero-inner",children:[i.jsxs("div",{className:"hero-content",children:[i.jsxs("div",{className:"badge",children:[i.jsx("span",{className:"dot"})," Live Now"]}),i.jsxs("h1",{children:["Get Best ",i.jsx("br",{}),i.jsx("span",{className:"highlight-text",children:u.replace("Get Best ","")})]}),i.jsx("svg",{className:"underline-svg",viewBox:"0 0 200 10",xmlns:"http://www.w3.org/2000/svg",children:i.jsx("path",{d:"M2,5 Q50,10 100,5 T200,5",fill:"none",stroke:"#FBBF24",strokeWidth:"3"})}),i.jsx("p",{className:"hero-desc",children:j}),i.jsxs("div",{className:"hero-rating",children:[i.jsx("span",{className:"stars",children:"★★★★★"}),i.jsx("span",{className:"rating-val",children:g}),i.jsxs("span",{className:"reviews-count",children:["| ",s," reviews"]})]}),i.jsxs("div",{className:"hero-actions",children:[i.jsx("button",{className:"btn-book",children:"Explore Services →"}),i.jsx("button",{className:"btn-call",children:"📞 Call Expert"})]})]}),i.jsx("div",{className:"hero-image-col",children:i.jsxs("div",{className:"expert-card",children:[i.jsxs("div",{className:"expert-badge",children:[i.jsx("span",{className:"icon",children:"🎧"}),i.jsxs("div",{className:"text",children:[i.jsx("span",{className:"label",children:"TOTAL"}),i.jsx("span",{className:"value",children:"25+ Services"})]})]}),i.jsx("img",{src:h&&(h.startsWith("http")?h:Ct(h))||"/vite.svg",alt:"Service Expert",className:"expert-img"}),i.jsxs("div",{className:"verified-badge",children:[i.jsx("img",{src:"/logo.png",className:"mini-logo",alt:""})," ",i.jsxs("div",{className:"info",children:[i.jsx("span",{className:"verified-text",children:"Verified Expert"}),i.jsx("span",{className:"expert-name",children:"Ramesh jha"})]})]})]})})]}),i.jsx("style",{children:`
      ...
      `})]})},up=({title:u,description:j})=>i.jsxs("div",{className:"service-about-section",children:[i.jsxs("div",{className:"container",children:[i.jsx("h2",{children:u}),i.jsx("div",{className:"about-text",children:j.split(`

`).map((g,s)=>i.jsx("p",{children:g},s))}),i.jsx("a",{href:"#book",className:"cta-link",children:"Book your service today and experience the Zervo Company difference!"})]}),i.jsx("style",{children:`
      ...
      `})]}),dp=({title:u,rating:j,reviews:g})=>i.jsxs("div",{className:"service-testimonials-section container",children:[i.jsxs("div",{className:"header",children:[i.jsx("h2",{children:u}),i.jsxs("div",{className:"rating-summary",children:[i.jsx("span",{className:"stars",children:"★★★★★"}),i.jsxs("span",{className:"avg-rating",children:[j," Average Rating"]})]}),i.jsxs("p",{className:"subtitle",children:["The service was exceptional. Zervo Company technician came within 2 hours, addressed the issue with professional care, ",i.jsx("br",{}),"and ensured everything was perfect. Truly satisfied!"]})]}),i.jsx("div",{className:"reviews-grid",children:g.map((s,h)=>i.jsxs("div",{className:"review-card",children:[i.jsx("div",{className:"card-stars",children:"★".repeat(s.rating)}),i.jsxs("p",{className:"review-text",children:['"',s.text,'"']}),i.jsxs("div",{className:"reviewer-info",children:[i.jsx("div",{className:"avatar-initial",children:s.name.charAt(0)}),i.jsxs("div",{className:"details",children:[i.jsx("span",{className:"name",children:s.name}),i.jsx("span",{className:"location",children:s.location})]})]})]},h))}),i.jsxs("div",{className:"nav-arrows",children:[i.jsx("button",{className:"arrow-btn left",children:"←"}),i.jsx("button",{className:"arrow-btn right",children:"→"})]}),i.jsx("style",{children:`
      ...
      `})]}),fp=({serviceIdParam:u})=>{const{navigate:j}=tt(),{data:g}=Cl(),s=u||"",h=g?.[s];return D.useEffect(()=>{window.scrollTo(0,0)},[s]),h?i.jsxs("div",{className:"service-page",children:[i.jsx(sp,{title:h.title,description:h.description,rating:h.rating,reviewsCount:h.reviewsCount,expertImage:h.expertImage}),h.categories?h.categories.map(N=>i.jsx(Lf,{title:N.title,subServices:N.services},N.id)):i.jsx(Lf,{title:`Top ${h.title} Experts`,subServices:h.subServices}),i.jsx(dp,{title:`Customer Reviews – ${h.title}`,rating:h.rating,reviews:h.reviews}),i.jsx(up,{title:h.about?.title,description:h.about?.description}),i.jsx(Vf,{}),i.jsx(Kf,{}),i.jsx(Jf,{})]}):(setTimeout(()=>j("/"),0),null)},mp=()=>{const{currentPath:u}=tt(),j=u==="/admin"||u.startsWith("/admin/"),g=()=>typeof localStorage<"u"&&!!localStorage.getItem("admin_token"),s=u.match(/^\/service\/([^/]+)$/);let h;if(j)h=g()?i.jsx(ip,{}):i.jsx(Ih,{});else if(u==="/"||u==="")h=i.jsx(qf,{});else if(s)h=i.jsx(fp,{serviceIdParam:s[1]});else if(u.startsWith("/book/")){const B=u.split("/book/")[1];h=i.jsx(Jh,{serviceName:B})}else u==="/partner"?h=i.jsx(Kh,{}):u==="/contact"?h=i.jsx(Wh,{}):u==="/about"?h=i.jsx(Fh,{}):u==="/privacy"?h=i.jsx($h,{}):u==="/terms"?h=i.jsx(Ph,{}):u==="/blog"?h=i.jsx(op,{}):u.match(/^\/blog\/([^/]+)$/)?h=i.jsx(cp,{slug:u.match(/^\/blog\/([^/]+)$/)[1]}):h=i.jsx(qf,{});const O=["/partner","/contact","/about","/privacy","/terms"].includes(u)||j;return i.jsxs("div",{className:"app-container",children:[!O&&i.jsx(rp,{}),!O&&i.jsx(Cn,{}),h,!O&&i.jsx(Ml,{})]})},gp=()=>i.jsx(Ah,{children:i.jsx(mp,{})});function hp({children:u}){const[j,g]=D.useState(!1);return D.useEffect(()=>{Bh().then(s=>{if(s&&typeof document<"u"){const h=document.documentElement;s.primary_color&&h.style.setProperty("--color-primary",s.primary_color),s.secondary_color&&h.style.setProperty("--color-secondary",s.secondary_color),s.accent_color&&h.style.setProperty("--color-accent",s.accent_color),s.bg_color&&h.style.setProperty("--color-bg",s.bg_color)}}).catch(()=>{}).finally(()=>g(!0))},[]),u}function pp(){return i.jsx(hp,{children:i.jsx(qh,{children:i.jsx(gp,{})})})}_h.createRoot(document.getElementById("root")).render(i.jsx(D.StrictMode,{children:i.jsx(pp,{})}));
